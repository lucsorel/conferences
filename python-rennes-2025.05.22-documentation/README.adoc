...
Export pdf des actualités : link:2025.05.22-documentation-quoi_de_noeuf.pdf[2025.05.22-documentation-quoi_de_noeuf.pdf] (source : link:2025.05.22-documentation-quoi_de_noeuf.adoc[2025.05.22-documentation-quoi_de_noeuf.adoc]).

Présentations et personnes intervenantes :

* **Florian Strzelecki** : Documentation : trouver son style link:2025.05.22-Florian_Strzelecki-Documentation-Trouve_ton_style.pdf[2025.05.22-Florian_Strzelecki-Documentation-Trouve_ton_style.pdf].
