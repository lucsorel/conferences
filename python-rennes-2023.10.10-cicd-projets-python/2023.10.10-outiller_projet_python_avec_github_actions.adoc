...
L'outil https://pre-commit.com/[pre-commit] utilise les mécanismes de hook de git pour lancer des outils à différentes étapes du cycle de vie git d'un projet.
...
* intégration avec le service https://pre-commit.ci/[pre-commit.ci]
...
- doc https://docs.github.com/en/actions/managing-workflow-runs/skipping-workflow-runs[skip ci]
- hook https://github.com/alessandrojcm/commitlint-pre-commit-hook[commitlint]
- doc https://python-semantic-release.readthedocs.io/en/latest/index.html[Python Semantic Release]

--

== Les Github actions !

image::assets/code_ci_ci_yo.webp[width="50%"]
